...
namespace Microsoft.Framework.Caching.Memory
{
    public class MemoryCache : IMemoryCache
    {
        ...
        public object Set(object key, object value, MemoryCacheEntryOptions cacheEntryOptions)
        {
            ...
            if (link != null)
            {
                // Copy tokens and AbsoluteExpiration to the link.
                // We do this regardless of it gets cached because the tokens are associated with the value we'll return.
                if (entry.Options.ChangeTokens != null)
                {
                    link.AddChangeTokens(entry.Options.ChangeTokens);
                }
        ...
        public bool TryGetValue(object key, out object value)
        {
            ...
            try
            {
                ...
                {
                    // Check if expired due to tokens, timers, etc. and if so, remove it.
